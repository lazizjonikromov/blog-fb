        ...
        <div className="mt-[8rem] flex flex-col md:flex-row gap-10">
          <div className="flex-[1]">
            ...
            <p className="text-gray-500 pt-4 text-sm">
              <span className="font-bold">Note: </span> Lorem ipsum dolor sit
              amet consectetur, adipisicing elit. Voluptates, ad sapiente
              aperiam odio repudiandae alias, cupiditate odit excepturi earum
              perspiciatis velit, quisquam ducimus iure quam.
            </p>
          </div>
          ...
          <div className="flex-[1] flex flex-col gap-4 mb-5 md:mb-0">
            <h3 className="text-2xl ">
              Publishing to:{" "}
              <span className="font-bold capitalize">Laziz Web</span>
            </h3>
            <p>
